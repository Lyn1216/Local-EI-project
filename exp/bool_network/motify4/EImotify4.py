...
functionsname = [bifan, twoFFL, fourone, FBL4, fiveone, fivetwo, fivethree, sixone, sixtwo, sixthree, sixfour, sevenone, seventwo, seventhree, eightone, eighttwo, nine, ten, eleven, twelve]
motifyname = ["fourone", "bifan", "FBL4", "twoFFL", "fiveone", "fivetwo", "fivethree", "sixone", "sixtwo", "sixthree", "sixfour", "sevenone", "seventwo", "seventhree", "eightone", "eighttwo", "nine", "ten", "eleven", "twelve"]
...
for key in keys:
    ...
    for function in functionsname:
        un, un_en, syn, dicts = cal_motify(function, file_dict[key], 4)
        net_un.update(un)
